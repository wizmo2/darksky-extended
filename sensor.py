...
class DarkSkySensor(Entity):
    ...
    def device_state_attributes(self):
        ...
        return {ATTR_ATTRIBUTION: self._attribute}
...
class DarkSkyData:
    ...
    def __init__(self, api_key, latitude, longitude, units, language, interval, url):
